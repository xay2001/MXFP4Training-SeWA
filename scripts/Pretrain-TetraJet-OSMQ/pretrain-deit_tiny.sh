...
OSMQ_TAU=1.0
Experiment_NAME="TetraJet-MXFP4-OSMQ-EMA${EMA_DECAY}-S${OSMQ_START_STEP}"
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.run --nproc_per_node=4 --master_port=29502 main.py \
